<?php echo form_open(); ?>
    <div class="brand-lable modal-dialog">
      ...
      <h1>Edit Shop</h1><br>
        ...
        <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <span class="login-help"><?php echo form_error('shop_name'); ?></span>
             <input type="text" class="form-control" name="shop_name" value="<?php echo $shop_id = $id; ?>" >
        ...
        <input type="submit" name="login" class="login loginmodal-submit" value="Update Shop">
